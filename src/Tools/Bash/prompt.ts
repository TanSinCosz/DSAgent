...
export function getSimplePrompt(): string {
    return [
        ...
        "- For long-running tests, builds, servers, or watchers, set run_in_background to true instead of using shell job control or a trailing &.",
        "- Background commands return a task id and output file. Use Read for output and TaskStop when the process is no longer needed.",
